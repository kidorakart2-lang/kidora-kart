  ...
  return (
    <div
      ...
      className={cn(
        ...
        "border border-brand-500/30 bg-brand-600 shadow-sm dark:border-brand-400/30 dark:bg-brand-700",
    ...
    >
      <button
        ...
        className={cn(
          ...
          "hover:bg-brand-700 dark:hover:bg-brand-300",
      ...
      <div className="flex h-full w-full items-center justify-center">
        <span
          ...
          className={cn(
            "pointer-events-none mx-auto max-w-md text-sm text-brand-100 dark:text-brand-300",
            ...
            "bg-gradient-to-r from-transparent via-white/80 via-50% to-transparent dark:via-brand-950/80"
          )}
        >
          {text}
        </span>
