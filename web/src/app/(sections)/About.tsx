...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-50/60 via-background to-brand-100/40">
      {/* Main Content */}
          ...
          <div className="space-y-6">
            ...
            <div className="liquid-card rounded-3xl overflow-hidden shimmer">
              <img
                ...
                alt="Traditional Indian Jewellery Store"
          ...
          <div className="space-y-6">
            ...
            <div className="liquid-glass rounded-3xl p-8 shimmer relative z-10">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h1 className="text-4xl fw-heading text-foreground">About Us</h1>
                  <div className="w-20 h-1 bg-gradient-to-r from-brand-500 to-brand-300 rounded-full mt-2"></div>
                </div>
              </div>
