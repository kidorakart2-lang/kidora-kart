 ...
 *     description: Admin "Why Choose Us" section CRUD
 *
 * /api/admin/whyChooseUs/view:
 *   post:
 *     tags: [Admin - Why Choose Us]
 ...
 *
 * /api/admin/whyChooseUs/details/{id}:
 *   post:
 *     tags: [Admin - Why Choose Us]
 ...
 *         application/json:
 *           schema:
 *             $ref: '#/components/schemas/AdminWhyChooseUsInput'
 *     responses:
 *       201:
 ...
 *               $ref: '#/components/schemas/InternalError'
 *
 * /api/admin/whyChooseUs/update/{id}:
 *   put:
 *     tags: [Admin - Why Choose Us]
 ...
 *               $ref: '#/components/schemas/InternalError'
 *
 * /api/admin/whyChooseUs/delete/{id}:
 *   put:
 *     tags: [Admin - Why Choose Us]
 ...
 *               $ref: '#/components/schemas/InternalError'
 *
 * /api/admin/whyChooseUs/change-status/{id}:
 *   put:
 *     tags: [Admin - Why Choose Us]
 *     summary: Change entry status
 *     security:
 *       - BearerAuth: []
 *       - CookieAuth: []
 *     parameters:
