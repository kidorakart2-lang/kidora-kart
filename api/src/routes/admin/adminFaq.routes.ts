 ...
 * tags:
 *   - name: Admin - FAQs
 *     description: Admin FAQ CRUD operations
 *
 * /api/admin/faq/view:
 *   post:
 *     tags: [Admin - FAQs]
 *     summary: Get all FAQs (paginated)
 *     security:
 *       - BearerAuth: []
 *       - CookieAuth: []
 *     responses:
 ...
 *         application/json:
 *           schema:
 *             $ref: '#/components/schemas/AdminFaqInput'
 *     responses:
 *       201:
...
import {
  ...
  changeStatus,
  restore,
} from "../../controller/admin/adminFaq.controller.js";
