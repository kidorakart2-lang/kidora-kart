 ...
 * tags:
 *   - name: Admin - Sizes
 *     description: Admin size option CRUD
 *
 * /api/admin/size/view:
 *   post:
 *     tags: [Admin - Sizes]
 *     summary: Get all sizes (paginated)
 *     security:
 *       - BearerAuth: []
 *       - CookieAuth: []
 *     responses:
 ...
 *         application/json:
 *           schema:
 *             $ref: '#/components/schemas/AdminSizeInput'
 *     responses:
 *       201:
