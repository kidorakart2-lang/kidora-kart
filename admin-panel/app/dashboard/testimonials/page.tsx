...
export default function TestimonialsPage() {
  ...
  const restoreMutation = useMutation({
    mutationFn: (id: string) => api.put(`/api/admin/testimonial/restore/${id}`, { id }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["testimonials"] });
      invalidateCache(["testimonials", "homepage"]);
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2 pt-2">
                ...
                {deletedFilter === "deleted" && (
                  <Button variant="outline" size="sm" onClick={() => restoreMutation.mutate(testimonial._id!)} className="flex-1 transition-all duration-200 hover:scale-105" disabled={isPending}>
